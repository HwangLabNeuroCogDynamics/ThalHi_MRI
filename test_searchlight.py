...
searchlight_context = nilearn.decoding.SearchLight(mask, process_mask_img=mask, estimator = pipeline, radius=4, n_jobs=4, verbose=0, cv=LeaveOneGroupOut())
...
searchlight_color = nilearn.decoding.SearchLight(mask, process_mask_img=mask, estimator = pipeline, radius=4, n_jobs=4, verbose=0, cv=LeaveOneGroupOut())
...
searchlight_shape = nilearn.decoding.SearchLight(mask, process_mask_img=mask, estimator = pipeline, radius=4, n_jobs=4, verbose=0, cv=LeaveOneGroupOut())
...
searchlight_task = nilearn.decoding.SearchLight(mask, process_mask_img=mask, estimator = pipeline, radius=4, n_jobs=4, verbose=0, cv=LeaveOneGroupOut())
